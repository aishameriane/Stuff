...
Reinterprete $I$ com,o uma esperan?a em rela??o a $\theta \sim U(1,2)$ (escolhida de maneira conveniente dentro dos intervalos de integra??o). Sabemos que a densidade de uma 
...
## Exemplo 2: Cumulative density of the normal distribution
...
To see how to generate the Figure, check the code [here]().
...
**Obs:** numerical values in the text are obtained directly using R, check the code [here]() to see the procedure. This example is an adaptation from Robert and Casella's MC methods book.
